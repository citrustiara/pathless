...
async function main() {
  ...
  const output = {
    ...
    coverage: COVERAGE,
    license: "GUGiK public-sector information reuse terms; source and processing attribution required",
    reuseTermsUrl: "https://www.gov.pl/web/gugik/ponowne-wykorzystanie-informacji-sektora-publicznego",
    processing: "Fetched as EPSG:2180 AAIGrid tiles, mosaicked, bilinearly resampled to a ~3 m geographic grid, and quantized to decimetres",
